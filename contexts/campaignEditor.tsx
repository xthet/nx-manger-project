...
function CampaignEditorProvider ({ children, cmpAddress, validator }:{children:ReactNode, cmpAddress:string, validator:Function}) {
  ...
  useEffect(()=>{
    async function getCmp(){
      const cmp = await fetch(campaignDetails.campaignURI.replace("ipfs://", "https://ipfs.io/ipfs/"))
    ...
    campaignDetails && campaignDetails.campaignURI && getCmp().catch(e=>console.log(e))
