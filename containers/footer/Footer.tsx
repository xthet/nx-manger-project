...
function Menu(){
  return (
    <>
      <Link href="/campaigns" className="ft-menu-link">{"Campaigns"}</Link>
      <Link href="./" className="ft-menu-link">{"About us"}</Link>
      <Link href="/#blog" className="ft-menu-link">{"Blog"}</Link>
      <Link href="/#how-it-works" className="ft-menu-link">{"Help"}</Link>
    </>
  )
}
