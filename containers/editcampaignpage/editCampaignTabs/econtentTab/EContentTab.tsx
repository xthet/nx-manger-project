...
export default function EContentTab() {
  ...
  const { updateGrandCmp, setActiveTab, grandCmp, staticCmp, currAddress, ptitle } = useContext(CampaignEditorContext)!
          ...
          "be sure to include frequently asked questions (FAQ), to help your description"}
            ...
            <div className="ct-container">
              <div className="ct-submit">
                <button className="ct-submit-btn" onClick={()=>{handleContentSave()}}>{"Save"}</button>
              </div>
              {/* campaign story */}
              ...
              "A good pitch is compelling, informative, and easy to digest. Learn more."}
                ...
                <Editor 
                  ...
                  init={{ width:"100%", height:700, menubar:false, images_upload_handler: uploadImg, image_caption: true }}
                  value={story}
            ...
            "questions about crowdfunding and how Manger works"}
              ...
              <div className="ct-submit">
                <button className="ct-submit-btn" onClick={()=>{handleContentSubmit()}}>{"Continue"}</button>
              </div>
            </div>
          </div>
      }
