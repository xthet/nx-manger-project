...
export default function ETeamTab() {
  const { updateGrandCmp, setActiveTab, grandCmp, currAddress, setGrandURI, loading, ptitle, activeTab } = useContext(CampaignEditorContext)!
  ...
  useEffect(()=>{
    function findCmp(){
      ...
      if(!loading && findGrandCmp){
        ...
        setSelectedOption({ value:findGrandCmp.location, label:findGrandCmp.location })
        setCmpTwit(findGrandCmp.twitter == "_NIL" ? "" : findGrandCmp.twitter)
      }
    }
    setTimeout(()=>{findCmp()}, 1000)
  },[grandCmp, ptitle])
  ...
  useEffect(()=>{
    ...
    const inr = setInterval(()=>{getLinkBal().catch(e=>console.log(e))}, 10000)
    ...
    <>
      {
        !currAddress
          ? <div className="ct-denial">
            <p>{"You need an existing campaign smart contract to add team details"}</p>
          ...
          "your campaign page as members of your team."}
              ...
              <form className="rt-card-form" onSubmit={(e)=>{e.preventDefault()}}>
                ...
                <div className="rt-form-inpt-grp">
                  ...
                  <div className="rt-form-inpt-sm-grp">
                    ...
                    <input type="text" name="t-twit" className="rt-form-inpt"
                      placeholder="https://www.twitter.com/username" value={cmpTwit}
                ...
                <div className="rt-form-inpt-grp">
                  ...
                  <div className="rt-form-inpt-sm-grp">
                    ...
                    <textarea name="t-bio" className="rt-form-inpt" cols={91} rows={3}
              ...
              <div className="tt-cta">
                <button className="tt-cta-btn" onClick={(e)=>{addiRef.current!.click(); handleTeamSubmit()}}>
                  {"Publish Campaign"}
                </button>
              </div>
            </div>
