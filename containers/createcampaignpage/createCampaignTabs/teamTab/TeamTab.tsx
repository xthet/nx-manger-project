...
export default function TeamTab() {
	...
	const uploadGrandCmp = onetime(async () => {
		...
		const grandCmpData = {
			...
			key: `manger/grandCmpUplds/${truncateStr(account, 10)}/MNG_${
				grandCmp.title
			}_${timestamp}`,
			data: JSON.stringify(grandCmp),
		}
		const cmpContract = new ethers.Contract(
			newCampaignAddr,
			Campaign.abi,
			signer
		)
		...
		<>
			{!newCampaignAddr ? (
				<div className="ct-denial">
					<p>
						{"You need an existing campaign smart contract to add team info"}
					</p>
					...
					<div className="ct-container">
						...
						<div className="ct-card">
							...
							<p className="ct-card-subtitle">
								{"Add other members of your campaign here:"}
							</p>
						...
						>
							...
							<div className="rt-form-inpt-grp">
								...
								<div className="rt-form-inpt-sm-grp">
									...
									/>
									<small>
										{cmpTwit && "https://www.twitter.com/" + cmpTwit}
									</small>
								</div>
							</div>
							...
							<div className="tt-link-bal-wrp">
								...
								<div className="tt-link-bal-cont">
									...
									{ilinkLdng ? (
										...
										>
											<button className="tt-get-link-btn">{"GET LINK"}</button>
										</Link>
									)}
								</div>
							</div>
