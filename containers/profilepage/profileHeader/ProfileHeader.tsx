    ...
    <section className="crh-section sc-padding fl-cl fl-c">
      <div className="crh-bio fl-tl">
        <div className="crh-blck-dshbrd-grp fl-cl fl-c">
          {uData && uData.pfp && (uData.pfp != "_NIL") ? <img src={uData.pfp.replace("ipfs://", "https://ipfs.io/ipfs/")} alt="--" className="crh-pfp"/>
            : <Blockies seed={currProfile.toLowerCase()} scale={8} size={11} 
      ...
      <div className="crh-menu fl-tc">
        <div className="crh-tab-menu fl-cl">
          <h3 className={`crh-tab-title ${activeTab == "CREATED" && "crh-active-tab"}`}
            onClick={()=>{setActiveTab("CREATED")}}
          >
            {"CREATED"}
          </h3>
          <h3 className={`crh-tab-title ${activeTab == "BACKED" && "crh-active-tab"}`}
