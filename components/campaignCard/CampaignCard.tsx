      ...
      <div className="cc-details fl-cl fl-c">
        <div className="cc-cta fl-tc fl-sb">
          <div className="cc-cat-name fl-cl">
            ...
            <Link href={`/campaigns${loading ? "" : "/"}${loading ? "" : campaignDetails.category}`}>
        ...
        <div className="cc-status fl-cl fl-sb">
          ...
          <div className="cc-progress-bar"><div className="cc-progress-level" style={{ "width": `${progress >= 100 ? 100 : progress}%` }}></div></div>
        ...
        <div className="cc-creator-eta fl-cl fl-sb">
          <div className="cc-creator fl-cl">
            {(userDets && userDets.pfp && (userDets.pfp != "_NIL")) ? <img src={userDets.pfp.replace("ipfs://", "https://ipfs.io/ipfs/")} alt="--" className="cc-creator-pfp"/> :
